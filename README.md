...
Instructions: 
	1. Dowload GlobalFusion Dataset at (link)                                                   
	2. Run Gen_dataset.py to generate templates for all recipes                                  ---- DONE AND CLEAN
	3. Run Gen_recipes_LLMs.py to generate the recipes for a given LLM                           ---- DONE AND CLEAN 
	4. Run GlobalFusion_withLLMS_Generation.py to pair the generated LLMs in one file with GF    ---- DONE AND CLEAN             
	5. Run measuring_novelty.py to generate the novelty scores for a Given LLM                   ---- DONE AND CLEAN
